...
#%%
self = volcanoRLQL(number_of_episodes=rl_config.number_of_episodes*4,
                   gamma=rl_config.gamma,
                   alpha=0.001,
                   epsilon=0.05,
                   env_dim=(6,20))
...
self.deepqlearning(agent_position=agent_position, cliff_positions=cliff_positions, goal_position=goal_position)
